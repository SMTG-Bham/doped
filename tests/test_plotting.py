...
class DefectPlottingTestCase(unittest.TestCase):
    def test_format_defect_name(self):
        ...
        defect_species_w_site_info_name_dict = {
            ...
            "Cd_i_Td_Te2.83_2": "Cd$_{i_{Td_Te2.83}}^{+2}$",
            "Te_i_Td_Cd2.83_-2": "Te$_{i_{Td_Cd2.83}}^{-2}$",
            ...
            "Y_i_C4v_O1.92_0": "Y$_{i_{C4v_O1.92}}^{0}$",
            "Y_i_C4v_O2.68_1": "Y$_{i_{C4v_O2.68}}^{+1}$",
            "Y_i_Cs_O1.71_-2": "Y$_{i_{Cs_O1.71}}^{-2}$",
            "Y_i_Cs_O1.95_2": "Y$_{i_{Cs_O1.95}}^{+2}$",
            "Y_i_D2d_0": "Y$_{i_{D2d}}^{0}$",
            "v_O_C1_0": "$V_{O_{C1}}^{0}$",
            "v_O_C3_8": "$V_{O_{C3}}^{+8}$",
            "Li_i_C1_Li1.75_0": "Li$_{i_{C1_Li1.75}}^{0}$",
            "Li_i_C1_O1.72_1": "Li$_{i_{C1_O1.72}}^{+1}$",
            "Li_i_C1_O1.78_2": "Li$_{i_{C1_O1.78}}^{+2}$",
            "Li_i_C2_Li1.84O1.84_0": "Li$_{i_{C2_Li1.84O1.84}}^{0}$",
            "Li_i_C2_Li1.84O1.94_1": "Li$_{i_{C2_Li1.84O1.94}}^{+1}$",
            "Li_i_C2_Li1.86_2": "Li$_{i_{C2_Li1.86}}^{+2}$",
            "Li_i_C3_0": "Li$_{i_{C3}}^{0}$",
            "Cu_i_Oh_0": "Cu$_{i_{Oh}}^{0}$",
            "Cu_i_Td_0": "Cu$_{i_{Td}}^{0}$",
            "Cu_i_C3v_Ag1.56Cu1.56Ag2.99a_0": "Cu$_{i_{C3v_Ag1.56Cu1.56Ag2.99a}}^{0}$",
            "Cu_i_C3v_Ag1.56Cu1.56Ag2.99b_0": "Cu$_{i_{C3v_Ag1.56Cu1.56Ag2.99b}}^{0}$",
            "Cu_i_C3v_Ag1.80_0": "Cu$_{i_{C3v_Ag1.80}}^{0}$",
            "Te_i_C1_Cd2.71Te2.71Cd4.25j_-2": "Te$_{i_{C1_Cd2.71Te2.71Cd4.25j}}^{-2}$",
            "Te_i_C1_Cd2.71Te2.71Cd4.25l_-2": "Te$_{i_{C1_Cd2.71Te2.71Cd4.25l}}^{-2}$",
            "v_Cd_C1_Te2.83Cd4.62Te5.42a_-1": "$V_{Cd_{C1_Te2.83Cd4.62Te5.42a}}^{-1}$",
            "v_Cd_C1_Te2.83Cd4.62Te5.42b_-1": "$V_{Cd_{C1_Te2.83Cd4.62Te5.42b}}^{-1}$",
            "v_Cd_C3v_Cd2.71_-1": "$V_{Cd_{C3v_Cd2.71}}^{-1}$",
            "v_Cd_C3v_Te2.83Cd4.25_-1": "$V_{Cd_{C3v_Te2.83Cd4.25}}^{-1}$",
            "v_Cd_C3v_Te2.83Cd4.62_-1": "$V_{Cd_{C3v_Te2.83Cd4.62}}^{-1}$",
        }
        for (
            defect_species,
            expected_name,
