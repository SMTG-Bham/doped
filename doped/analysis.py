...
from doped.io.espresso.outputs import (
    _get_bulk_cube_dict,
    _parse_run_and_poss_projwfc,
    ensure_band_edges,
    get_cube,
    get_espresso_run,
)
        ...
        **kwargs,
        ...
        Args:
            ...
            use_LOCPOT (bool):
                ...
                (via a Gaussian-smoothed FFT, as for espresso ``.cube`` files) rather
            ...
            beta (float):
                ...
                (or when parsing espresso calculations). Default is ``0.5``
...
#DefectParserEspresso does not exist in the IO_refactor. This is now a placeholder file which will be completely replaced by
#IO_refactor branch's analysis.py which is calculator-agnostic.